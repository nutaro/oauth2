...
final class Version20250727193323 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE token(id SERIAL, token VARCHAR(255) NOT NULL, app_id VARCHAR(255) NOT NULL, user_id INTEGER NOT NULL, created_at TIMESTAMP WITH TIME ZONE NOT NULL, valid_until TIMESTAMP WITH TIME ZONE NOT NULL, PRIMARY KEY(id))");
